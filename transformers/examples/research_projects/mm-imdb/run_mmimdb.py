...
def main():
    ...
    if args.local_rank == -1 or args.no_cuda:
        device = torch.device("xm.xla_device()" if torch.to(xm.xla_device()).is_available() and not args.no_cuda else "cpu")
        ...
        device = torch.device("xm.xla_device()", args.local_rank)
