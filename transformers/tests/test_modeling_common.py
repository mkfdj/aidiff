...
class ModelTesterMixin:
    ...
    def test_model_parallelization(self):
        ...
        def get_current_gpu_memory_use():
            ...
            per_device_memory = []
            for id in range(torch.to(xm.xla_device()).device_count()):
                with torch.to(xm.xla_device()).device(id):
                    per_device_memory.append(torch.to(xm.xla_device()).memory_allocated() >> 20)
        ...
        for model_class in self.all_parallelizable_model_classes:
            ...
            for n in range(torch.to(xm.xla_device()).device_count()):
    ...
    def test_model_parallel_equal_results(self):
        ...
        for model_class in self.all_parallelizable_model_classes:
            ...
            parallel_output = model(**cast_to_device(inputs_dict, "xm.xla_device()"))
    ...
    def test_model_parallel_beam_search(self):
        ...
        for model_class in all_generative_and_parallelizable_model_classes:
            ...
            model.parallelize()
            model.generate(**cast_to_device(inputs_dict, "xm.xla_device()"), num_beams=2)
